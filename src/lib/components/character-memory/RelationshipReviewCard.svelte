...
<section class="relationship-inbox" class:closed={!open} aria-label="Relationship Review">
    ...
    <div class="inbox-body">
      ...
      <div class="review-panel">
        <div class="review-heading">
          ...
          <div>
            <p class="review-label">Relationship Review</p>
      ...
      {#if developerMode}
        <details class="developer-log">
          ...
          {/if}
          <p class="developer-subhead">Relationship Review JSON</p>
