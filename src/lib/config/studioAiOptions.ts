...
export const ROLE_AI_OPTIONS = ['INHERIT', 'GPT-5.5', 'GPT-5.6 Terra', 'GPT-5.6 Luna', 'GPT-5.6 Sol', 'Grok', 'Gemini', 'Claude', 'Local LLM'] as const;
...
export const VIDEO_AI_SELECT_OPTIONS: VideoAiSelectOption[] = [
  { id: 'MiniMax H3', label: 'MiniMax H3（RunPod RTX 5090）', help: 'オープンウェイトH3をRunPodで実行し、最大9枚の参照画像から音声付き動画を生成します。' },
