<script lang="ts">
  ...
  import { PROVIDER_MODELS, PROVIDER_OPTIONS, modelLabel, type AIProvider } from '$lib/config/models';
  import {
  ...
  let voiceEngine = $state<VoiceEngineType>('irodori-tts');
        ...
        <div class="vc-rows">
          <div class="vc-row">
            ...
            <select class="vc-select" bind:value={voiceEngine}>
              <option value="irodori-tts">IRODORI TTS (RECOMMENDED)</option>
